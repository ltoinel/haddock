...
export function bindDOM() {
  return {
    ...
    optSites: getElement("#opt-sites"),
    optSitesInput: getElement<HTMLInputElement>("#opt-sites-input"),
    sitesTags: getElement("#sites-tags"),
    sitesDropdown: getElement("#sites-dropdown"),
